...
class AvatarHover {
  ...
  AvatarHover({
    ...
    this.statusWidth = 20,
  }) : assert(itemsMenu == null, "itemsMenu cannot be null");
            ...
            children: [
              ...
              Positioned(
                ...
                child: Container(
                  decoration: BoxDecoration(
                    borderRadius: BorderRadius.circular(100),
                    color: online ? const Color(0xFF44E011) : Colors.grey,
  ...
  Future menuAvatar(PointerHoverEvent e) {
    ...
    return showMenu(
        ...
        shape: RectangleShapeBorder(
          borderRadius:
              DynamicBorderRadius.all(DynamicRadius.circular(6.toPXLength)),
        ),
